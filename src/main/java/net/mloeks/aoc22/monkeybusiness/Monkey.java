...
public class Monkey {
    ...
    private final Function<BigInteger, Integer> findTargetMonkey;
    ...
    public Monkey(final List<String> description) {
        ...
        final int divideBy = extractSingleNumberOnLine(description.get(3));
        ...
        this.findTargetMonkey = input -> input.remainder(BigInteger.valueOf(divideBy)).equals(BigInteger.ZERO)
...
//        System.out.println("Monkey " + id + " throws item " + item + " to monkey " + targetMonkey.getId());
    ...
    public Function<BigInteger, Integer> getFindTargetMonkey() {
