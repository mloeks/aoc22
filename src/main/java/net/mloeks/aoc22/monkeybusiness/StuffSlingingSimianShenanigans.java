...
public class StuffSlingingSimianShenanigans {
    ...
    private final BigInteger superModulo;
    ...
    public StuffSlingingSimianShenanigans(
        ...
        this.superModulo = BigInteger.valueOf(this.monkeys.values().stream().map(Monkey::getTestDivisibleBy)
    ...
    private void playRound() {
        for (int monkeyId : monkeys.keySet()) {
            ...
            while (monkeyItems.hasNext()) {
                ...
                int throwTo = monkey.getFindTargetMonkey().apply(afterInspection, superModulo);
